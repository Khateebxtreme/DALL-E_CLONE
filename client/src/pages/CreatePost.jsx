...
const CreatePost = () => {
  ...
  const handleSubmit = async(e)=>{
    ...
    if(form.prompt && form.photo){
      ...
      alert("please entet a prompt and generate an image")
    }
  }
  ...
  return (
    ...
    <div>
      ...
      <p className='mt-2 text-[#666e75] text-[17px] max-w-[500px]'>Create visually scintillating images through DALL-E Artificial Intelligence to share them with the community</p>
    </div>
    <div>
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        <div className='flex flex-col gap-5'>
          ...
          <FormField labelName = "Prompt"
            type = "text"
            name = "prompt"
            placeholder = "Teletubbies on crack"
            value = {form.prompt}
            handleChange = {handleChange}
            isSurpriseMe
